...
<?php
    session_start();
    if ($_REQUEST['tk'] || $_REQUEST['mkkh']){
        $usName = $_SESSION['ten'];  
    }elseif ($_REQUEST['huyDon']){
        $usName = $_SESSION['ten'];  
    }elseif ($_SESSION['login'] && $_SESSION['type']=='khachhang' && $_SESSION['id'] == $_REQUEST['kh']){
        $usName = $_SESSION['ten'];  
    } else {
    ...
    <div class="container py-3">
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-md-2 re-767 text-header">
                <a href="indexKh.php" class="">Trang chủ</a>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-5">
                <form class="d-flex sua-tim-kiem">
                    <input class="form-control rounded-pill" type="search" style="width:100%" placeholder="Search"
                        aria-label="Search" disabled style="width:500px">
                    <button class="btn btn-outline-success rounded-pill sua-tim" disabled type="submit"><i
