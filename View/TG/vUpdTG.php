...
<?php
    ...
    while ($row = mysql_fetch_assoc($tblTG)) {
        $HoTen = $row['HoTen'];
    ...
    <form class='form-group' action="#" method='post' enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input id="tgName" value="<?php echo $HoTen?>" name="tgName" placeholder="Nhập tên tác giả" class="form-control input-md"
                        type="text">
                </div>
                <div class="col-md-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input id="tgYear" value="<?php echo $formattedDate?>" name="tgYear" placeholder="Nhập ngày sinh" class="form-control input-md"
                        type="text">
                </div>
                <div class="col-md-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input id="tgQuocTich" value="<?php echo $QuocTich?>" name="tgQuocTich" placeholder="Nhập quốc tịch" class="form-control input-md"
                        type="text">
                </div>
                <div class="col-md-4"> 
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input id="tgNgheDanh" value="<?php echo $NgheDanh?>" name="tgNgheDanh" placeholder="Nhập nghệ danh" class="form-control input-md"
                        type="text">
                </div>
                <div class="col-md-4">
